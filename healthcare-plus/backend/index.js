...
const endpoint = process.env["GITHUB_TOKEN"] ? "https://models.inference.ai.azure.com" : undefined;
...
if (!token) {
  console.warn("⚠️ WARNING: Neither GITHUB_TOKEN nor OPENAI_API_KEY environment variable is set. AI features will fail.");
}
const client = new OpenAI({
  ...(endpoint ? { baseURL: endpoint } : {}),
  apiKey: token || 'missing-key'
});
